...
* `:nrepl-cljs` -- pulls in the latest stable release of [nREPL](https://github.com/nrepl/nREPL) and [piggieback](https://github.com/nrepl/piggieback) and starts an ClojureScript capable nREPL server on port 60606 
